			...
			//if ( planets.length > 1 )
			{
				...
				{	
					...
					if (planets[i].innerHTML.indexOf('class="icon-moon"') > 0) 
					{
						...
						//console.log(idPlanete[nbPlanet]);
			...
			{		
				...
				if(FireFox  || Tamper)
				{
					...
					*/
					...
					var einhalt=document.getElementById('contentWrapper');
				...
				if(document.getElementById('planet'+idPlanete[nbplanete]) )
				{
					...
					if( !isMoon )
					{
						...
						if( empireoptions[0] == "true" )
						{
							...
							var prod_d_total = prodDeut   (lvldeut   ,speed, lvlplasma   , temperature , geologue, coeffbosterdeut);
